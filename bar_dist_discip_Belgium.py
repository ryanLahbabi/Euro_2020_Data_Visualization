...
def prep_distribution_data(df):
    ...
    df_distribution = df[df['PlayerSurname'].isin(['Lukaku', 'Hazard','Vanaken', 'De Bruyne','Meunier','Mertens', 'Vertonghen', 'Vermaelen', 'Carrasco', 'Castagne'])]
...
def prep_disciplanary_data(df):
    ...
    df_disciplanary = df[df['PlayerSurname'].isin(['Lukaku', 'Hazard','Vanaken', 'De Bruyne','Meunier','Mertens', 'Vertonghen', 'Vermaelen', 'Carrasco', 'Castagne'])]
